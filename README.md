...
+ Setmana del 28/9: 
  ...
  + Pràctica: 
    + Notebook bàsics Variables. Resoldre els problemes 1-8 i 10-13. El problema 9 és optatiu. 
+ Setmana del 5/10:
  + Classe presencial: 
    + Problemes de	Notebook Teoría Variables (representació caràcters, cadenes de text). Exercicis 5 a 9; 
    + Problemes de	Notebook Teoría Col.leccions (llistes). Exercici 1 i Exercici 2; 
    + Problemes de Notebook Teoría Control (tot). 
  + Contingut en línia (Mireia): [Python]   
  + Pràctica: 
...
+ Setmana del 19/10: 
  + Classe presencial: 
    ...
    + Càlcul complexitat exercicis fets a lab anterior
    + 3.7(Calculadora) 
    + 3.10(Setmanes i segons)
  + Contingut en línia (Jordi): [Algorismes Numèrics](http://algorismica2020.github.io/classes/numerics1.html)
  + Pràctica: 
    + 3.3(Numeracio en diferents bases). Preg 1 i 3
    + 3.10(Restriccions múltiples Tres condicions)
    + 3.11(La seqüència de Fibonacci). Preg 2 i 3
+ Setmana del 26/10: 
  + Classe presencial: Revisió els exercicis de la pràctica. 
    + 3.6(Aritmètica modular). Preg 2 Columna fulles de càlcul
    + 3.9(Primeritat i el teorema de Fermat). Preg 1 Primer de Weiferich
    + Càlculs de complexitat 
  + Contingut en línia (Jordi): [Algorismes Numèrics]
  + Pràctica: 
    + 3.2(El màxim comú divisor i les seves aplicacions). Preg 1
    + 3.6(Aritmètica modular). Preg 1 Lletra NIF
    + 3.9(Primeritat i el teorema de Fermat). Preg 2 Test de primeritat
+ Setmana del 2/11: 
  + Classe presencial: 
    + Revisar exercicis lab anterior
    + Glossari i algorismes bàsics. Dubtes
  + Contingut en línia (Jordi): [Algorismes Numèrics]   
  + Pràctica: 
    + 3.5(Operacions amb nombres binaris). Preg 1
    + 3.8(Primeritat). Preg 1 Factor primer més gran
    + 3.1(Divisió entera)
+ Setmana del 9/11: 
  + Classe presencial: 
    + 4.2(Alfabet aviació)
